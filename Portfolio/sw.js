...
const CACHE_NAME = 'kjr-portfolio-v2.65';
const CHART_JS_URL = 'https://cdn.jsdelivr.net/npm/chart.js@4.4.1/dist/chart.umd.min.js';

const CORE_ASSETS = [
  './index.html',
  './Worker/theme-init.js',
  './Worker/app.js?v=2.65',
  './Worker/kjr-core.js?v=2.65',
  './Worker/kjr-sortable.js?v=2.65',
  './Worker/kjr-vault.js?v=2.65',
  './Worker/kjr-migration.js?v=2.65',
  './Worker/supabase.js?v=2.65',
  './Worker/kjr-nas.js?v=2.65',
